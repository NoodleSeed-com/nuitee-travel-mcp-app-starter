...
| Decision | Resolution |
| --- | --- |
| Package | Pin `@noodleseed/one` exactly to `0.137.0`; regenerate the lockfile and Agent Kit on every update. |
