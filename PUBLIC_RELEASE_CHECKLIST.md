...
- [ ] Run `pnpm ci:offline`, `pnpm check:browser`, and `pnpm audit:release` in the fresh public candidate after a frozen install.
- [ ] Inspect the homepage, flight and hotel screenshots and verify their exact blob entries and fictional-data provenance.
...
- [ ] Inspect the exported tree and its new history for internal material, secrets and unreviewed binaries.
