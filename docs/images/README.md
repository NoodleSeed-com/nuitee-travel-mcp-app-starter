...
or reviewed test identifiers, and the Wayfare sample brand. They
...
session; do not submit a prompt for this capture. Review every changed image before committing it.
