...
import { Feedback, Flow, Frame, Region, StatusBadge, useLayout, useSendFollowUpMessage, useToolInfo, useWidgetReady } from '../helpers.js';
...
export function TravelHomeView({
  ...
  if (state === 'loading') {
    return (
      <Frame className={frameClassName} displayMode="auto" title={starterConfig.brand.name}>
