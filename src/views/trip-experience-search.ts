...
export type TripExperienceSearchPlan = {
  ...
  readonly dateBasis?: 'flight_date_suggestion' | 'trip_dates_suggestion' | 'stay' | 'experience_search';
...
export function planTripExperienceSearch(review: DemoTripReview): TripExperienceSearchPlan {
  ...
  return { input, dateBasis: flightBased ? usesFlightDay ? 'flight_date_suggestion' : 'trip_dates_suggestion' : context.dateBasis as 'stay' | 'experience_search',
    note: flightBased
      ...
      : 'Using your activity or stay dates. You can change them in chat.' };
}
