...
| `select_flight_offer` | Remember the fare selected inside the flight-results widget for a later verification turn. | write; open-world; confirmation required | app only |
